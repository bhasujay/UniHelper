    ...
    <div class="auth-container" style="justify-content: center;">
      <div class="auth-card">
        <div class="auth-card-header">
          ...
          <p class="auth-subtitle">Sign in to your UniHelper account</p>
        </div>
        
        <?php if (isset($error)): ?>
        <div class="error-message" style="background: #fee; color: #c33; padding: 10px; margin: 10px 0; border-radius: 5px; border: 1px solid #fcc;">
          <?php echo htmlspecialchars($error); ?>
        </div>
        <?php endif; ?>
        
        <form class="auth-form" id="loginForm" method="post" action="/UniHelper/login">
          <!-- Email Field -->
          ...
          <button type="submit" class="btn btn-primary btn-full btn-lg" id="loginBtn">
            ...
            <i class="btn-loading-icon" style="display: none;"></i>
          </button>
          <!-- Sign Up Link -->
